...
- The day in the year leaves start to fall vs latitude for various tree types:

2. Which line is which in the following models?

- One line is a standard OLS; the other uses weighted regression.

```{r, cache=F, echo=F, fig.width=4.5, fig.height=2.5, fig.align='center', warning=F}
...
stats_df[nrow(stats_df) + 1, ] = c(NA, NA, NA, NA)
